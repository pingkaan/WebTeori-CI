        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('store-product') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                                    <input type="radio" name="category" value="clothes" class="selectgroup-input" checked="">
                                    <span class="selectgroup-button">Clothes</span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="radio" name="category" value="pants" class="selectgroup-input">
                                    <span class="selectgroup-button">Pants</span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="radio" name="category" value="shoes" class="selectgroup-input">
                        ...
                        <div class="form-group">
                            <div class="d-flex flex-row">
                                <div class="col-md-4">
                                    <img src="<?= base_url('img/img-preview.png') ?>" alt="image" class="img-fluid" width="100" id="preview">
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <input id="price" type="number" class="form-control " name="price" tabindex="1" required autofocus>
